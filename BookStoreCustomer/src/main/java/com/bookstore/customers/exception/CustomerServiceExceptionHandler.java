...
public class CustomerServiceExceptionHandler {
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(CustomerServiceException.class)
    public ResponseEntity<Response> handleInsuranceCategoryException (CustomerServiceException exception){
